...
import { getPropertiesByType } from "@/lib/mock-data";
...
const PropertyListingPage = ({ propertyType }: PropertyListingPageProps) => {
  ...
  useEffect(() => {
    ...
    if (selectedCity && selectedCity !== "all") {
      result = result.filter(
        (property) => property.location.city.toLowerCase() === selectedCity.toLowerCase()
      );
    }
    ...
    if (selectedAmenities.length > 0) {
      result = result.filter((property) =>
        selectedAmenities.every((amenity) => property.amenities.includes(amenity as any))
      );
    }
  ...
  }, [properties, priceRange, searchTerm, selectedCity, selectedAmenities, sortOption]);
    ...
    <Layout>
      <div className="bg-gray-50 py-8">
        <div className="container">
          <div className="mb-8">
            <h1 className="text-3xl font-bold mb-2">{typeToTitle[propertyType]}</h1>
            <p className="text-gray-600">
              Find the perfect {propertyType === "FLAT" ? "flat" : propertyType === "PG" ? "PG" : "hostel"} accommodation tailored to your needs
            </p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className={`lg:w-1/4 ${isFilterMobileOpen ? 'block' : 'hidden'} lg:block`}>
              <div className="bg-white rounded-lg shadow-sm p-6 sticky top-24">
                ...
                <Accordion type="multiple" defaultValue={["price", "amenities"]}>
            ...
            <div className="lg:w-3/4">
              <div className="mb-4 flex items-center justify-between">
                ...
                {(selectedAmenities.length > 0 || selectedCity !== "all" || searchTerm) && (
