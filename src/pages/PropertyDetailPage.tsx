      ...
      <div className="bg-gray-50 py-3 border-b">
        <div className="container">
          <div className="flex items-center text-sm text-gray-600">
            ...
            <Link
              to={`/${property.type === "FLAT" ? "flats" : property.type === "PG" ? "pgs" : "hostels"}`}
      ...
      <div className="container py-8">
        ...
        <div className="relative mb-8 bg-gray-100 rounded-lg overflow-hidden">
          ...
          <button
            ...
            className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-white/80 p-2 rounded-full hover:bg-white shadow-sm"
          ...
          <button
            ...
            className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-white/80 p-2 rounded-full hover:bg-white shadow-sm"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div>
            <div className="bg-white border rounded-lg shadow-sm p-6 sticky top-24">
              ...
              {showContactForm && (
                <form onSubmit={handleContactOwner} className="mt-4 space-y-4 border-t pt-4">
                  <div>
                  ...
                  <AccordionItem value="item-1">
                    ...
                    <AccordionContent>
                      ...
                      <ul className="text-sm text-gray-600 list-disc list-inside space-y-1">
                        ...
                        <li>
                          Don't make payments without viewing/confirming property
                        </li>
                        <li>
                          Report suspicious activity to our customer support team
                        </li>
                      </ul>
                    </AccordionContent>
                  </AccordionItem>
