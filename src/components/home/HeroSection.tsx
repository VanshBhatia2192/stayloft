...
const HeroSection = () => {
  ...
  const handleSearch = () => {
    ...
    const searchUrl = propertyType === "FLAT" 
      ? "/flats" 
      : propertyType === "PG" 
      ? "/pgs" 
      : propertyType === "HOSTEL" 
      ...
      <div className="container relative z-10 py-24 md:py-32 lg:py-40">
        <div className="max-w-3xl">
          ...
          <p className="text-lg md:text-xl text-gray-200 mb-8">
            Discover the best flats, PGs, and hostels across India with our comprehensive 
            rental platform designed for comfort and convenience.
          </p>
          ...
          <div className="flex flex-wrap gap-8 mt-12 text-white">
            <div>
              ...
              <p className="text-gray-300">Accommodations</p>
            </div>
            <div>
